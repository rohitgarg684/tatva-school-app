...
router.post("/content/:contentId/complete", async (req, res) => {
  try {
    const uid = req.uid!;
...
// POST /api/vote/:voteId/cast
router.post("/vote/:voteId/cast", async (req, res) => {
  try {
    const uid = req.uid!;
...
// POST /api/vote/:voteId/close
router.post("/vote/:voteId/close", async (req, res) => {
  try {
    const { voteId } = req.params;
...
// POST /api/behavior-point
router.post("/behavior-point", async (req, res) => {
  try {
    const uid = req.uid!;
