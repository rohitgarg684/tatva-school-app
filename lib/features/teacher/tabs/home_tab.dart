        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
              ...
              child: Column(children: [
                Row(children: [
                  Expanded(child: QuickActionButton(label: 'Classes', icon: Icons.class_outlined,
                      color: TatvaColors.primary, onTap: () => onSwitchTab(5))),
                  const SizedBox(width: 8),
                  Expanded(child: QuickActionButton(label: 'Attend', icon: Icons.fact_check_outlined,
                      color: TatvaColors.success, onTap: () => onSwitchTab(6))),
                  const SizedBox(width: 8),
                  ...
                  Expanded(child: QuickActionButton(label: 'Post\nHomework', icon: Icons.assignment_outlined,
                      color: TatvaColors.info, onTap: () => onSwitchTab(9))),
                ]),
                const SizedBox(height: 8),
                Row(children: [
                  Expanded(child: QuickActionButton(label: 'Behavior', icon: Icons.emoji_events_outlined,
                      color: TatvaColors.warning, onTap: () => onSwitchTab(7))),
                  const SizedBox(width: 8),
                  Expanded(child: QuickActionButton(label: 'Messages', icon: Icons.chat_outlined,
                      color: TatvaColors.purple, onTap: () => onSwitchTab(10))),
                  const SizedBox(width: 8),
