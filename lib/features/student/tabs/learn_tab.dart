...
class StudentLearnTab extends StatelessWidget {
  final List<ContentItem> contentItems;
  final String uid;
  final void Function(ContentItem item) onMarkCompleted;
            ...
            return Column(
                ...
                children: [
                  ...
                  ...items.asMap().entries.map((itemEntry) {
                    ...
                    final completed = ci.isCompletedBy(uid);
                        ...
                        child: Container(
                          ...
                          Container(
                              ...
                              child: Icon(
                                  ...
                                  color: completed ? TatvaColors.success : TatvaColors.info,
                                  size: 20)),
